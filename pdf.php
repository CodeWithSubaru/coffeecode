...
class PDF extends TCPDF {
    public function Header() {
        $imageFile = K_PATH_IMAGES.'logo_company-png.jpg';
        $this->Image($imageFile, 10, 10, 60, '', 'jpg', '', 'T', false, 300, '', false, false, 0, false, false, false);
